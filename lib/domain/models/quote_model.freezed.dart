...
abstract class $QuoteModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String author, String quote});
}
...
class _$_QuoteModel implements _QuoteModel {
  const _$_QuoteModel({required this.author, required this.quote});
  ...
  @override
  String toString() {
    return 'QuoteModel(author: $author, quote: $quote)';
  }
...
abstract class _QuoteModel implements QuoteModel {
  const factory _QuoteModel(
      ...
      required final String quote}) = _$_QuoteModel;
